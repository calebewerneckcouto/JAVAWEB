                              ...
                              <li class="pcoded-hasmenu">
                                  ...
                                  <ul class="pcoded-submenu">
                                      ...
                                      <li class=" ">
                                       ...
                                       <li class=" ">
                                          <a href="<%= request.getContextPath() %>/principal/gcode.jsp"  class="waves-effect waves-dark">
                                              <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                              <span class="pcoded-mtext" data-i18n="nav.basic-components.alert">GCode</span>
                                              <span class="pcoded-mcaret"></span>
                                          </a>
                                      </li>
