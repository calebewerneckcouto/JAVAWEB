...
Lembre-se de substituir "url_do_videoX" pelas URLs reais dos seus vídeos. Você pode adicionar quantos <iframe> de vídeo desejar dentro do <div class="video-wrapper">.
  ...
  <div id="pcoded" class="pcoded">
      ...
      <div class="pcoded-container navbar-wrapper">
       ...
       <iframe  src="https://www.youtube.com/embed/vULxaxKcQnk" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
          <iframe  src="https://www.youtube.com/embed/2fQV_k9aYHU" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
